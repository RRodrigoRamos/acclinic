...
@section('title', 'Area Cliente - Meus Dados')
@section('topoInfor')
...
<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
      <div class="alert alert-info">
            ...
            <div class="text"><i class="fa fa-info-circle fa-2x "></i> &nbsp; DADOS CLIENTE - PACIENTE ! <span class="obr"> obs: ( * ) Campos obrigatórios<span></div> 
        </div>
    </div> 
    {{ dd($dados) }}  
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
   <form class="form"  method="post" action="/areaCliente/meus_dadosSalvo">
        @csrf
    <fieldset>
